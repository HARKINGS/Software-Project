...
let isModalOpen = false; // Biến kiểm tra trạng thái model
        ...
        <div class="basic-details">
          <div class="infor-column">
            ...
            <div class="detail-row">
              ...
              <input class="value" id="editNumberhouse" value="${household.numHouse}" />
            </div>
          ...
          <div class="infor-column">
            <div class="detail-row">
              <span class="label">Số ô tô:</span>
              <input class="value" id="editNumCars" value="" />
            </div>

            <div class="detail-row">
              <span class="label">Số xe máy:</span>
              <input class="value" id="editMotors" value="" />
            </div>
          </div>
        </div>
